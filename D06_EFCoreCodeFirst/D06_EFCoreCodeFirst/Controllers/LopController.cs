...
namespace D06_EFCoreCodeFirst.Controllers
{
    public class LopController : Controller
    {
        ...
        public LopController(MyDbContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("MaLop,TenLop,CVHT")] Lop lop)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("MaLop,TenLop,CVHT")] Lop lop)
        {
            if (id != lop.MaLop)
            {
                return NotFound();
